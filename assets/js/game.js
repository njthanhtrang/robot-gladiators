...
var startGame = function () {
    ...
    for (var i = 0; i < enemyInfo.length; i++) {
        ...
        if (playerInfo.health > 0) {
            ...
            // if player's still alive after fight and we're not at last enemy in array
...
var shop = function () {
    ...
    // check if prompt answer was left blank, player hit "cancel", or provided a #
    if (shopOptionPrompt === null || shopOptionPrompt === "" || isNaN(shopOptionPrompt)) {
        window.alert("You need to provide a valid answer! Please try again.");
        return shop();
    }
    // convert answer from prompt to an actual #
...
var fightOrSkip = function () {
    ...
    // validate prompt answer with Conditional Recursive Function Call
    if (promptFight === "" || promptFight === null || !isNaN(promptFight)) {
        window.alert("You need to provide a valid answer! Please try again.");
        // use return to call fx again and stop the rest of fx from running
        return fightOrSkip();
    }
    // convert promptFight to all lowercase to check wiht less options
